...
<?php
    if(isset($_POST["them"])){
      ...
      $sql = "INSERT INTO tbl_nhanvien(Anh,Manhanvien,Ten,Gioitinh,Ngaysinh,Quequan,Chucvu) 
      VALUES('$file','$manhanvien','$ten','$gioitinh','$ngaysinh','$quequan','$chucvu')"; 
  ...
  <?php
    ...
    <ul class="dropdown-menu" role="menu" aria-labelledby="menu2">
      ...
      <li role="presentation"><a role="menuitem" tabindex="-1" href="#">In</a></li>
            ...
            <button type = "submit" name = "them" class = "btn btn-primary btn-lg btn-block">Thêm</button>
                </form>
