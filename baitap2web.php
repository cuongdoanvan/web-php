  ...
  <div style = "background-color: #191970; /* Orange */" id="sidebar">
    ...
    <ul class="nav">
      <li>
        <a href="quanlynhanvien.php">
          <span class="fa fa-user mr-3"></span> Quản lý nhân sự
        </a>
      </li>
        ...
        <a href="khenthuong.php">
          <span class="fa fa-sticky-note mr-3"></span> Khen thưởng-Kỷ luật
					...
					<div  style = "background-color: #191970; /* Orange */"  class="well">
						<h4>Nhân Viên Nam</h4>
						<div class="progress">
							<div class="progress-bar" role="progressbar" aria-valuenow="" aria-valuemin="0" aria-valuemax="100" style="width: 70%;">
								<?php
							echo "$nam";
							?>
							</div>
						...
						<h4>Nhân Viên Nữ </h4>
						<div class="progress">
							<div class="progress-bar" role="progressbar" aria-valuenow="400" aria-valuemin="0" aria-valuemax="100" style="width: 30%;">
							<?php
							echo "$nu";
							?>
							</div>
   ...
   <div id="content">
    ...
    <ul class="dropdown-menu" role="menu" aria-labelledby="menu1">
      ...
      <li role="presentation"><a role="menuitem" tabindex="-1" href="#">Riêng tư</a></li>
...
if ($result=mysqli_query($conn,$sql)){
  ...
  $result=mysqli_query($conn,$sql);
    ...
    echo "<tr><td>".$row["STT"]."</td><td>".$row["Ten"]." </td><td>".$row["Giamdoc"]."</td><td> ".$row["Diachi"]."</td></tr>";
  }
  mysqli_free_result($result);
...
<footer class="container-fluid text-center">
 <a href="baitap2web.php" title="To Top">
